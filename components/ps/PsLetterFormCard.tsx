...
type Props = {
  letter: PsLetterRecord;
  index: number;
  total: number;
  disabled?: boolean;
  onChange: (updated: PsLetterRecord) => void;
  onMergePrevious: () => void;
  onMergeNext: () => void;
  onRemove: () => void;
};

export function PsLetterFormCard({
  letter,
  index,
  total,
  disabled,
  ...
  const update = (patch: Partial<PsLetterRecord>) => onChange({ ...letter, ...patch });
